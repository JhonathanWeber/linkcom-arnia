...
userRoutes.get(
  "/user-find/email", Authentication.handler,
...
userRoutes.get("/users/inactives", Authentication.handler, Authorization.handlerAdmin, Authorization.handlerAdmin, userModule.getAllDelete.bind(userModule));
